/**
 * AWS Developer Tools Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { DEVELOPER_TOOLS_SERVICES, DEVELOPER_TOOLS_ICONS, DeveloperToolsServiceDefinition } from './developerToolsServicesData';
...
export function getDeveloperToolsServiceIcon(resourceType: string): string {
  return DEVELOPER_TOOLS_ICONS[resourceType] || DEVELOPER_TOOLS_ICONS['aws_codebuild_project'];
}
