/**
 * AWS Machine Learning Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { MACHINE_LEARNING_SERVICES, MACHINE_LEARNING_ICONS, MachineLearningServiceDefinition } from './machineLearningServicesData';
...
export function getMachineLearningServiceIcon(resourceType: string): string {
  return MACHINE_LEARNING_ICONS[resourceType] || MACHINE_LEARNING_ICONS['aws_sagemaker_domain'];
}
