/**
 * AWS Analytics Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { ANALYTICS_SERVICES, ANALYTICS_ICONS, AnalyticsServiceDefinition } from './analyticsServicesData';
...
export function getAnalyticsServiceIcon(resourceType: string): string {
  return ANALYTICS_ICONS[resourceType] || ANALYTICS_ICONS['aws_athena_database'];
}
