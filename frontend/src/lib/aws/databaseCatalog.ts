/**
 * AWS Database Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { DATABASE_SERVICES, DATABASE_ICONS, DatabaseServiceDefinition } from './databaseServicesData';
...
export function getDatabaseServiceIcon(resourceType: string): string {
  return DATABASE_ICONS[resourceType] || DATABASE_ICONS['aws_db_instance'];
}
