/**
 * GCP Storage Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { STORAGE_SERVICES, STORAGE_ICONS } from './storageServicesData';
...
export function getStorageServiceIcon(resourceType: string): string {
  return STORAGE_ICONS[resourceType] || STORAGE_ICONS[STORAGE_SERVICES[0].terraform_resource];
}
