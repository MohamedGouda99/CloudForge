/**
 * GCP Messaging Catalog - For ResourcePalette display
...
export function getMessagingServiceIcon(resourceType: string): string {
  return MESSAGING_ICONS[resourceType] || MESSAGING_ICONS[MESSAGING_SERVICES[0].terraform_resource];
}
