/**
 * Azure Machine Learning Catalog - For ResourcePalette display
...
export function getMachineLearningServiceIcon(resourceType: string): string {
  return MACHINE_LEARNING_ICONS[resourceType] || MACHINE_LEARNING_ICONS['azurerm_machine_learning_workspace'];
}
