/**
 * Azure Containers Catalog - For ResourcePalette display
 * This provides the catalog entries that appear in the resource palette
 */

import { CONTAINERS_SERVICES, CONTAINERS_ICONS } from './containersServicesData';
...
export function getContainersServiceIcon(resourceType: string): string {
  return CONTAINERS_ICONS[resourceType] || CONTAINERS_ICONS['azurerm_kubernetes_cluster'];
}
