/**
 * Azure Resources Library
 * Exports all Azure service definitions, schemas, and utilities
 */
...
// Helper function to get Azure service icon
export function getAzureServiceIcon(terraformResource: string): string | undefined {
...
// Helper function to check if resource has Azure service definition
export function hasAzureServiceDefinition(terraformResource: string): boolean {
